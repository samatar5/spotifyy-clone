  ...
  return (
    <Layout>
      <div className="flex items-end gap-3 bg-gradient-to-b from-primary/60 to-bg-dimmed p-10">
        {isLoading ? (
          <div className="h-28 w-28 flex-shrink-0 animate-pulse bg-text-dimmed md:h-60 md:w-60"></div>
        ) : (
          <img
          ...
          {isLoading
            ? Array(20)
                ...
                .map((_, index) => (
                  <div
                    key={index}
                    className="group grid animate-pulse grid-cols-[auto_1fr_1fr_auto] items-center gap-4 rounded-md py-1.5 px-6  text-sm "
                  >
                    <div className="w-8">
                    ...
                    <div className="flex items-center gap-4 ">
                      ...
                      <div className="w-full">
                        <div className="mb-2 h-4 w-4/6 bg-neutral-600"></div>
